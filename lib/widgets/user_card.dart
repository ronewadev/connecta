...
import '../screens/plans/widgets/premium_badge.dart';
...
class _UserCardState extends State<UserCard> {
      ...
      child: Stack(
        children: [
            ...
            child: GestureDetector(
              ...
              child: Stack(
                children: [
                  ...
                  // Visual feedback areas (only show if multiple images)
                  if (_images.length > 1) ...[
                    // Left tap area
                    Positioned(
                      left: 0,
          ...
          Positioned(
            ...
            child: Column(
              children: [
                // Infinity icon to indicate linked social platforms
                Container(
  ...
  Widget _buildSocialIconButton(IconData icon, Color color, String platform) {
    return InkWell(
      onTap: () {
